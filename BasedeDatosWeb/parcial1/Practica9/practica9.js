    ...
    $("#dar_carta").click(function()  {
        ...
        while (b) {
            ...
            if (cartas[num - 1] == true) {
                ...
                $("#carta_activa").html("<img width='50px' src='loteria/" + num + ".jpeg'>");
                cartas[num - 1] = true;
                b = false;
                cont++;
            }
    ...
    function cargarcartas() {
        ...
        while (carta1 < 16) {
            ...
            if (asignados[num - 1] == false) {
                $("#carta1").append("<div class='col-sm-3'><img class='img-fluid' src='loteria/" + num + ".jpeg'></div>");
        ...
        while (carta2 < 16) {
            var num = Math.floor(Math.random() * 54) + 1;
            if (asignados[num - 1] == false) {
                $("#carta2").append("<div class='col-sm-3'><img class='img-fluid' src='loteria/" + num + ".jpeg'></div>");
                asignados[num - 1] = true;
                carta2++;
            } else {
                continue;
